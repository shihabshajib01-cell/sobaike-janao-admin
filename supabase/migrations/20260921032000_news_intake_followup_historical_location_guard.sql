-- Final News Intake closeout: block arrest/enforcement follow-up headlines
-- and reject historical background phrases as current incident locations.
-- These are defense-in-depth equivalents of the Edge scanner rules.
