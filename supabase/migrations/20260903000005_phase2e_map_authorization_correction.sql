...
BEGIN
    ...
    -- 3. Fetch complaints limited strictly to safe geospatial & display fields
    ...
    -- 4. Fetch segments taxonomy for map filters
    ...
    -- 5. Fetch subcategories taxonomy for map filters
