...
export const MOCK_COMPLAINTS: Complaint[] = [
  {
    id: 'CMP-10495',
    titleEn: 'Excessive Electricity Bill Surge: 195% Jump in Residential Metring',
    titleBn: 'আবাসিক মিটারে অস্বাভাবিক বিদ্যুৎ বিল: এক মাসে প্রায় ২০০% অতিরিক্ত চার্জ',
    descriptionEn: 'The electricity bill for August 2026 reached 6,500 BDT compared to the standard July bill of 2,200 BDT with identical appliances and zero meter modification. Suspected tariff calculation irregularity or reading mistake.',
    descriptionBn: 'আগস্ট ২০২৬ মাসের বিদ্যুৎ বিল এসেছে ৬৫০০ টাকা, যেখানে জুলাই মাসে স্বাভাবিক ব্যবহারের বিল ছিল মাত্র ২২০০ টাকা। কোনো নতুন যন্ত্রপাতি যোগ করা হয়নি। মিটার রিডিংয়ে স্পষ্ট অসংগতি ও অতিরিক্ত চার্জ ধার্য করা হয়েছে।',
    categoryId: 'load_shedding',
    categoryEn: 'Utility Service Complaints',
    categoryBn: 'ইউটিলিটি সেবা অভিযোগ',
    subcategoryId: 'excess-electricity-bill',
    subcategoryEn: 'Excess Electricity Bill',
    subcategoryBn: 'অতিরিক্ত বিদ্যুৎ বিল',
    location: {
      addressEn: 'House 14, Road 5, Block B, Banasree, Rampura, Dhaka',
      addressBn: 'বাড়ি ১৪, রোড ৫, ব্লক বি, বনশ্রী, রামপুরা, ঢাকা',
      ward: 'Rampura',
      zone: 'Dhaka',
      coordinates: [23.7634, 90.4312],
    },
    media: [
      {
        id: 'm-bill-1',
        ...
        caption: 'Electricity Meter & Bill Slip Copy',
      },
    ],
    status: 'submitted',
    urgency: 'high',
    ...
    isAnonymous: false,
    assignedDepartment: 'DESCO / DPDC Customer Grievance Cell',
    recentBillMonth: '2026-08',
    recentBillAmount: 6500,
    previousBillMonth: '2026-07',
    previousBillAmount: 2200,
    incidentDate: '2026-08-25',
    frequency: 'one-time',
    hasSupportingInfo: true,
    evidenceTypes: ['document_scan'],
    evidenceDescription: 'Attached recent electricity bill copy and previous month paid receipt for verification.',
    upvotesCount: 42,
    commentsCount: 9,
  ...
  {
    id: 'CMP-10494',
    titleEn: 'Repeated Unannounced Load Shedding During Peak Business Hours',
    titleBn: 'ব্যস্ত বাণিজ্যিক সময়ে বারবার পূর্বঘোষণা ছাড়াই তীব্র লোডশেডিং',
    descriptionEn: 'Continuous 4-hour power cut occurring every afternoon between 2:00 PM and 6:00 PM in the local market sector, severely impacting refrigerated food items and small local businesses.',
    descriptionBn: 'প্রতিদিন দুপুর ২টা থেকে সন্ধ্যা ৬টা পর্যন্ত টানা ৪ ঘণ্টা কোনো প্রকার পূর্বাভাস ছাড়াই লোডশেডিং হচ্ছে। স্থানীয় দোকানপাট ও কাঁচাবাজারের ফ্রিজিং ব্যবস্থা চরম ক্ষতির মুখে পড়েছে।',
    categoryId: 'load_shedding',
    categoryEn: 'Utility Service Complaints',
    categoryBn: 'ইউটিলিটি সেবা অভিযোগ',
    subcategoryId: 'load-shedding-outage',
    subcategoryEn: 'Load Shedding',
    subcategoryBn: 'লোডশেডিং',
    location: {
      addressEn: 'Station Road, Joydebpur, Gazipur Sadar, Gazipur',
      addressBn: 'স্টেশন রোড, জয়দেবপুর, গাজীপুর সদর, গাজীপুর',
      ward: 'Gazipur Sadar',
      zone: 'Gazipur',
      coordinates: [23.9985, 90.4243],
    },
    media: [],
    status: 'submitted',
    urgency: 'urgent',
    citizenName: 'Kawsar Ahmed',
    citizenPhone: '+8801911998877',
    isAnonymous: false,
    assignedDepartment: 'BREB / NESCO Regional Grid',
  ...
  {
    id: 'CMP-10493',
    titleEn: 'Zero Gas Pressure in Residential Pipeline Throughout Day',
    titleBn: 'আবাসিক লাইনে সারাদিন গ্যাস শূন্য, রান্না ও দৈনন্দিন কাজে চরম ভোগান্তি',
    descriptionEn: 'Gas pipeline pressure has dropped to zero since the past two weeks. Residents are forced to purchase expensive LP gas cylinders despite paying full monthly pipeline gas bills.',
    descriptionBn: 'গত দুই সপ্তাহ ধরে আবাসিক পাইপলাইনে গ্যাসের চাপ একদম শূন্য। মাসিক নির্ধারিত বিল পরিশোধ করার পরেও এলপিজি সিলিন্ডার ব্যবহার করতে বাধ্য হচ্ছেন শত শত পরিবার।',
    categoryId: 'load_shedding',
    categoryEn: 'Utility Service Complaints',
    categoryBn: 'ইউটিলিটি সেবা অভিযোগ',
    subcategoryId: 'gas-shortage',
    subcategoryEn: 'Gas Shortage',
    subcategoryBn: 'গ্যাস সংকট',
    location: {
      addressEn: 'Sector 11, Uttara, Dhaka',
      addressBn: 'সেক্টর ১১, উত্তরা, ঢাকা',
      ward: 'Uttara',
      zone: 'Dhaka',
      coordinates: [23.8741, 90.3846],
    },
    media: [],
    status: 'submitted',
    urgency: 'high',
    ...
    isAnonymous: true,
    assignedDepartment: 'Titas Gas Transmission & Distribution',
