          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/80 space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                ...
                <span className="inline-flex items-center gap-1 type-meta font-medium text-slate-400 dark:text-slate-500 bg-slate-200/60 dark:bg-slate-700/60 px-1.5 py-0.5 rounded">
              ...
              {technicalSlug ? (
                <Badge status="info" size="sm" className="font-mono type-meta">
                  <Sparkles className="w-3 h-3 mr-1" />
                  {t.roles.technicalIdAutoGenerated}
                </Badge>
              ) : null}
            </div>
