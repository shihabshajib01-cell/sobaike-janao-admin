...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    users: {
      ...
      passwordHelper: 'Use at least 12 characters. Known breached passwords are blocked.',
  ...
  bn: {
    ...
    users: {
      ...
      passwordLengthError: 'পাসওয়ার্ড কমপক্ষে ১২ অক্ষরের হতে হবে।',
      ...
      passwordHelper: 'কমপক্ষে ১২ অক্ষর দিন। ফাঁস হওয়া পরিচিত পাসওয়ার্ড গ্রহণ করা হবে না।',
